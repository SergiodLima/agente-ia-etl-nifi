...
📋 Pré-requisitos
Java JRE/JDK 11+ (para rodar o NiFi).
Apache NiFi instalado e rodando em https://localhost:8443.
Ollama instalado com o modelo llama3.2 ou phi3.
Ambiente Virtual Python (venv) configurado com as bibliotecas:
code
Bash
...
O Nome técnico e profissional para o componente.
A URL da API pública mais adequada para a tarefa.
...
No seu VS Code: Crie um arquivo chamado PROJETO.md e cole o conteúdo acima.
No GitHub: Se você subir esse código para o GitHub, o arquivo README.md será a página principal, mostrando para todos que você sabe unir IA + Engenharia de Dados.
No LinkedIn: Você pode tirar um print do seu NiFi com o box criado pela IA e postar: "Hoje automatizei o Apache NiFi usando Llama 3.2 local via Python. O futuro do ETL é autônomo!"